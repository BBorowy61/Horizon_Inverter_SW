...
extern Uint16  Flash_Program(volatile Uint16 far *FlashAddr, volatile Uint16 far *BufAddr, Uint32 Length, FLASH_ST *FProgStatus);
extern Uint16  Flash_Verify(volatile Uint16 far *StartAddr, volatile Uint16 far *BufAddr, Uint32 Length, FLASH_ST *FVerifyStat);
